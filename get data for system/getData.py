...
def get_n_hop_nodes(dbname, sql_sentence, node_id):
...
if __name__ == "__main__":
    ...
    # data mining   machine learning    human-computer interaction  Visualization
    # node_id_all = ['586652', '1034397', '710233', '1416227']
    node_id = '1416227'
    node_id_list = []
    node_id_list = get_n_hop_nodes(dbname, sql_sentence_edge, node_id)
    
    node_center  = [node_id] + node_id_list[1] + node_id_list[2]
    ...
    with open('data/Visualization.json' ,'w' ,encoding='utf-8') as f:

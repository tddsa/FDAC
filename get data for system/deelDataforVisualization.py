...
for i in nodes_all:
    ...
    elif temp <= 250: i['num_papers'] = {'attribute':'100~250', 'actual':temp}
    elif temp > 250: i['num_papers'] = {'attribute':'>250', 'actual':temp}
# 节点与属性的映射
node_map_attr = {}
for i in nodes_all:
...
for i in nodes_all:
    ...
    elif temp <= 3000: i['num_citation'] = {'attribute':'200~3000', 'actual':temp}
...
for i in nodes_all:
    ...
    elif temp <= 35: i['H_index'] = {'attribute':'20~35', 'actual':temp}
    elif temp > 35: i['H_index'] = {'attribute':'>35', 'actual':temp}
# 节点与属性的映射
node_map_attr = {}
for i in nodes_all:
...
with open('data/sample_Visualization.json', 'w', encoding='utf-8') as f:
    f.write(json_sample)
    f.close()
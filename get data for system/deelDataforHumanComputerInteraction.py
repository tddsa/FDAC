...
# 
dbname = "data/HumanComputerInteraction.db"
...
for i in nodes_all:
    temp = i['num_papers']
    if temp <= 1: i['num_papers'] = {'attribute':'<=1', 'actual':temp}
    elif temp <= 5: i['num_papers'] = {'attribute':'2~5', 'actual':temp}
    ...
    elif temp <= 300: i['num_papers'] = {'attribute':'100~300', 'actual':temp}
    elif temp > 300: i['num_papers'] = {'attribute':'>300', 'actual':temp}
# 节点与属性的映射
node_map_attr = {}
for i in nodes_all:
...
for i in nodes_all:
    temp = i['num_citation']
    if temp <= 1: i['num_citation'] = {'attribute':'<=1', 'actual':temp}
    elif temp <= 10: i['num_citation'] = {'attribute':'1~10', 'actual':temp}
    ...
    elif temp <= 1000: i['num_citation'] = {'attribute':'200~1000', 'actual':temp}
    ...
    elif temp > 1000: i['num_citation'] = {'attribute':'>1000', 'actual':temp}
# 节点与属性的映射
node_map_attr = {}
for i in nodes_all:
...
for i in nodes_all:
    temp = i['H_index']
    if temp <= 0: i['H_index'] = {'attribute':'=0', 'actual':temp}
    elif temp <= 1: i['H_index'] = {'attribute':'0~1', 'actual':temp}
    ...
    elif temp <= 20: i['H_index'] = {'attribute':'10~20', 'actual':temp}
    # elif temp <= 30: i['H_index'] = {'attribute':'20~30', 'actual':temp}
    elif temp > 20: i['H_index'] = {'attribute':'>20', 'actual':temp}
# 节点与属性的映射
node_map_attr = {}
for i in nodes_all:
...
# sample_HumanComputerInteraction
with open('data/sample_HumanComputerInteraction.json', 'w', encoding='utf-8') as f:
    f.write(json_sample)
    f.close()
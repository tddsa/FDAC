...
# 
dbname = "data/MachineLearning.db"
...
for i in nodes_all:
    ...
    elif temp <= 200: i['num_papers'] = {'attribute':'100~200', 'actual':temp}
...
for i in nodes_all:
    ...
    elif temp <= 150: i['num_citation'] = {'attribute':'50~150', 'actual':temp}
    elif temp <= 300: i['num_citation'] = {'attribute':'150~300', 'actual':temp}
    ...
    elif temp <= 3000: i['num_citation'] = {'attribute':'300~3000', 'actual':temp}
...
# sample_MachineLearning
with open('data/sample_MachineLearning.json', 'w', encoding='utf-8') as f:
    f.write(json_sample)
    f.close()